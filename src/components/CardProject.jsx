...
import "@egjs/preact-flicking/dist/flicking-inline.min.css";
  ...
  return (
    <div class="card">
      <div class="card-header">
        <img
          class="bg-image"
          src={openGraphImageUrl || imagePr.src}
          alt={name}
        />
        <div class="links">
      ...
      try {
        ...
        formattedData = data.user.pinnedItems.edges.map((el) => {
          ...
          const languages = el.node.languages.edges.map((lang) => {
            return {
              lang: lang.node.name.toLowerCase(),
